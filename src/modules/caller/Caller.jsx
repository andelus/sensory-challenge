...
const Caller = ({phrases}) => {
  ...
  return <div onClick={selectPhrase} className="flex justify-center items-center h-20 bg-blue-700 text-white text-3xl shadow-md rounded-xl ring-4 cursor-pointer">
